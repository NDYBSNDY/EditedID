...
Due to internal code refactoring and dependency cleanup, the full training pipeline is not yet available.
We will progressively release components after publication.
